...
//   return (
//     <div className="flex min-h-[40rem] relative items-center justify-center antialiased bg-white overflow-hidden">
...
//           </motion.linearGradient>
//         </defs>
//         {/* <div className="w-[13px] h-[13px] bg-slate-700 border border-[#d4d4d4] rounded-full absolute left-[851px] top-[34px]"></div> */}
//         <circle
//           cx="851"
//           cy="34"
//           r="6.5"
